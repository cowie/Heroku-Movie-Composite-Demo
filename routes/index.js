...
const listViewQuery = '(select title__c, tagline__c, vote_average__c, release_date__c, revenue__c from salesforce.movie__c order by random() limit 3) UNION ALL (select title__c, tagline__c, vote_average__c, release_date__c, revenue__c from salesforce.movie__c order by title__c asc limit 20 offset $1)';
